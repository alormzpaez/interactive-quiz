  ...
  return (
    <div className="w-full min-h-screen bg-blue-00 flex flex-col items-center">
      ...
      <div className="w-5/6 flex flex-col gap-2 bg-blue-00 items-center justify-center p-2">
        ...
        <input className='border-gray-600 border-2  w-4/6 p-2 m-2 text-center rounded-md text-gray-700' type="text" name="" id="" onChange={(e) => setUserId(e.target.value)} placeholder='Introduce Usuario' />
